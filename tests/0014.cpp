...
TEST_F(BesselErrorsTest, AllFunctionsSuccess)
{
  ...
  EXPECT_EQ(0, besselErrors[0].errorCode);
  EXPECT_EQ("Normal return        -- Computation completed.", besselErrors[0].errorMessage);
...
TEST_F(BesselErrorsTest, besselJPartialLossOfSignificance)
{
  ...
  besselJ(0, z, false, &besselErrors);
  EXPECT_EQ(3, besselErrors[0].errorCode);
  EXPECT_EQ(
...
TEST_F(BesselErrorsTest, besselJFulllLossOfSignificance)
{
  ...
  besselJ(0, z, false, &besselErrors);
  EXPECT_EQ(4, besselErrors[0].errorCode);
  EXPECT_EQ(
...
//
//   besselJ(0, z, false, &besselErrors);
//   EXPECT_EQ(5, besselErrors[0].errorCode);
...
{
  auto z = std::complex<double>(10.0, 10.0);
  besselKp(300, z, false, &besselErrors);
...
{
  auto z = std::complex<double>(35'000.0, 0.0);
  besselKp(0, z, false, &besselErrors);
...
{
  auto z = std::complex<double>(10.0, 10.0);
  hankelH1p(300, z, false, &besselErrors);
...
{
  auto z = std::complex<double>(35'000.0, 0.0);
  hankelH1p(0, z, false, &besselErrors);
...
{
  auto z = std::complex<double>(10.0, 10.0);
  hankelH2p(300, z, 1, &besselErrors);
...
{
  auto z = std::complex<double>(35'000.0, 0.0);
  hankelH2p(0, z, false, &besselErrors);
...
//  argument reduction produce less than half of machine accuracy", besselErrors[0].errorMessage);
//}
