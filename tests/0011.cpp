...
int main (void) {
  ...
  zDset = H5Dcreate(metadata_group, "z", H5T_NATIVE_DOUBLE, dataspace_z, H5P_DEFAULT, dcpl, H5P_DEFAULT);

  //
  hsize_t nu_max_array[1] = {nu_max};
  hid_t dataspace_nu = H5Screate_simple(1, nu_max_array, NULL);
  orderDset = H5Dcreate(metadata_group, "order", H5T_NATIVE_INT, dataspace_nu, H5P_DEFAULT, dcpl, H5P_DEFAULT);
