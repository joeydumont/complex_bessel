...
TEST_F(BesselScalingTest, besselJ)
{
  ...
  EXPECT_NEAR(std::real(expected), std::real(actual), 1.0e-3) << "BESSELJ scaling failed with z " << z << "\n";
  EXPECT_NEAR(std::imag(expected), std::imag(actual), 1.0e-3) << "BESSELJ scaling failed with z " << z << "\n";
}
...
TEST_F(BesselScalingTest, besselY)
{
  ...
  // Compare real and imag parts separately.
  EXPECT_NEAR(std::real(expected), std::real(actual), 1.0e-3) << "BESSELY scaling failed with z " << z << "\n";
  EXPECT_NEAR(std::imag(expected), std::imag(actual), 1.0e-3) << "BESSELY scaling failed with z " << z << "\n";
}
...
TEST_F(BesselScalingTest, besselI)
{
  ...
  // Compare real and imag parts separately.
  EXPECT_NEAR(std::real(expected), std::real(actual), 1.0e-3) << "BESSELI scaling failed with z " << z << "\n";
  EXPECT_NEAR(std::imag(expected), std::imag(actual), 1.0e-3) << "BESSELI scaling failed with z " << z << "\n";
}
...
TEST_F(BesselScalingTest, besselK)
{
  ...
  // Compare real and imag parts separately.
  EXPECT_NEAR(std::real(expected), std::real(actual), 1.0e-3) << "BESSELK scaling failed with z " << z << "\n";
  EXPECT_NEAR(std::imag(expected), std::imag(actual), 1.0e-3) << "BESSELK scaling failed with z " << z << "\n";
}
...
TEST_F(BesselScalingTest, hankelH1)
{
  ...
  // Compare real and imag parts separately.
  EXPECT_NEAR(std::real(expected), std::real(actual), 1.0e-3) << "HANKELH1 scaling failed with z " << z << "\n";
  EXPECT_NEAR(std::imag(expected), std::imag(actual), 1.0e-3) << "HANKELH1 scaling failed with z " << z << "\n";
}
...
TEST_F(BesselScalingTest, hankelH2)
{
  ...
  // Compare real and imag parts separately.
  EXPECT_NEAR(std::real(expected), std::real(actual), 1.0e-3) << "HANKELH2 scaling failed with z " << z << "\n";
  EXPECT_NEAR(std::imag(expected), std::imag(actual), 1.0e-3) << "HANKELH2 scaling failed with z " << z << "\n";
}
