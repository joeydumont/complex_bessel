...
inline std::complex<double> besselJ(double order, std::complex<double> z, bool scale = false, BesselErrors *error = nullptr)
{
 ...
 * \f$Y_{-\nu}(z) = (-1)^\nu Y_\nu(z)\f$ \cite ABR65 Sec 9.1.5. */
inline std::complex<double> besselY(double order, std::complex<double> z, bool scale = false, BesselErrors *error = nullptr)
{
    // Input values for Fortran subroutines
    double zr = std::real(z);
    double zi = std::imag(z);
 ...
 *  \cite ABR65 \S9.6.2.
 */
inline std::complex<double> besselI(double order, std::complex<double> z, bool scale = false, BesselErrors *error = nullptr)
{
  // Input values for Fortran subroutines.
  double zr = std::real(z);
  double zi = std::imag(z);
...
inline std::complex<double> besselK(double order, std::complex<double> z, bool scale = false, BesselErrors *error = nullptr)
{
  // Input values for Fortran subroutines.
  double zr = std::real(z);
  double zi = std::imag(z);
 ...
 * \f$. */
inline std::complex<double> hankelH1(double order, std::complex<double> z, bool scale = false, BesselErrors *error = nullptr)
{
    // Input values.
    double zr = std::real(z);
    double zi = std::imag(z);
 ...
 * formula \f$H^{(1)}_{-\nu}(z) = H^{(1)}_\nu(z)\exp\left(-\pi\nu\imath\right)\f$. */
inline std::complex<double> hankelH2(double order, std::complex<double> z, bool scale = false, BesselErrors *error = nullptr)
{
//    // Input values.
    double zr = std::real(z);
    double zi = std::imag(z);
...
inline std::complex<double> airy(std::complex<double> z, int id = 0, bool scale = false, BesselErrors *error = nullptr)
{
  // Input values.
  double zr = std::real(z);
  double zi = std::imag(z);
...
inline std::complex<double> biry(std::complex<double> z, int id = 0, bool scale = false, BesselErrors *error = nullptr)
{
  // Input values.
  double zr = std::real(z);
  double zi = std::imag(z);
